...
const Login = () => {
  ...
  return (
    <div className=' [@media(max-height:700px)]:mt-3 w-full  max-w-(--max-width) mx-auto flex flex-col p-(--padding) h-[90vh] md:flex-row items-center justify-center gap-0 md:gap-15 '>
